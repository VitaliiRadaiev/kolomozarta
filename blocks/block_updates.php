<?php
wp_enqueue_style('updates_style', get_theme_file_uri() . '/dist/css/blocks/block_updates.css');
global $data;

$updates_toggle = $data['updates_toggle'];
                        ...
                        <li class="updates__list-item">
                            ...
                            <div class="updates__list-item-info">
                                ...
                                <ul class="updates__list-item-audio">
                                    <?php if ($presto_player_plus->ID) : ?>
                                        <?= do_shortcode('[presto_player id="' . $presto_player_plus->ID . '"]'); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($updates_audio_minus->ID) : ?>
                                        <?= do_shortcode('[presto_player id="' . $updates_audio_minus->ID . '"]'); ?>
